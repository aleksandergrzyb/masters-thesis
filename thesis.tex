...
\input{content/podziekowania} % INCLUDE: acknowledgement
\cleardoublepage
...
\input{content/wstep}
\input{content/obrazowanie_oct}
\input{content/algorytmy_korejestracji}
\input{content/proponowane_algorytmy}
\input{content/oprogramowanie}
\input{content/wyniki_eksperymentow}
\input{content/podsumowanie_i_wnioski}
\cleardoublepage
